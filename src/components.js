...
export function ToggleGroup (props) {
    ...
    return React.createElement('toggleGroup', props);
}
...
export function PageView (props) {
    ...
    return React.createElement('pageView', props);
}
...
export function PortalIcon (props) {
    // return (<portalIcon {...props} />);
    return React.createElement('portalIcon', props);
}
